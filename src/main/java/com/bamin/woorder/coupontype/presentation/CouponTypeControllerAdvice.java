...
import com.bamin.woorder.coupontype.application.CouponTypeNotFoundException;
...
public class CouponTypeControllerAdvice {
    ...
    public ResponseEntity handleCouponTypeLengthException(final CouponTypeNotFoundException e, final HttpServletRequest request) {
        log.error(e.getMessage());
