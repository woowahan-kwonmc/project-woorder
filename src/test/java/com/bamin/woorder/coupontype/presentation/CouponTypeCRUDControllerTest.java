...
class CouponTypeCRUDControllerTest extends AcceptanceTestUtils {
    ...
    void successfullyCreateCouponType() {
        String startTime = LocalDateTime.now().plusDays(2L).toString();
        String endTime = LocalDateTime.now().plusDays(3L).toString();
        EasyRestAssured
    ...
    void failedCreateCouponTypeStartTimeIsEarlierThanCurrentTime() {
        String startTime = LocalDateTime.now().minusDays(3L).toString();
        String endTime = LocalDateTime.now().plusDays(3L).toString();
        EasyRestAssured
                .givenBody(new CouponTypeCreateRequestDto(
                        CREATE_COUPON_TYPE_NAME,
    ...
    void failedCreateCouponTypeEndTimeIsEarlierThan() {
        String startTime = LocalDateTime.now().minusDays(3L).toString();
        String endTime = LocalDateTime.now().minusDays(3L).toString();
        EasyRestAssured
                .givenBody(new CouponTypeCreateRequestDto(
                        CREATE_COUPON_TYPE_NAME,
                        CREATE_COUPON_TYPE_COUNT,
    ...
    void failedCreateCouponTypeSameStartAndEnd() {
        String sameTime = LocalDateTime.now().plusDays(3L).toString();
        EasyRestAssured
                .givenBody(new CouponTypeCreateRequestDto(
                        CREATE_COUPON_TYPE_NAME,
                        CREATE_COUPON_TYPE_COUNT,
    ...
    void failedCreateCouponTypePeriodIsEarlierThanNow() {
        String startTime = LocalDateTime.now().minusDays(3L).toString();
        String endTime = LocalDateTime.now().minusDays(1L).toString();
        EasyRestAssured
                .givenBody(new CouponTypeCreateRequestDto(
                        CREATE_COUPON_TYPE_NAME,
                        CREATE_COUPON_TYPE_COUNT,
